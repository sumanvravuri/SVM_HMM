...
#    svm_hmm_obj.train(lambda_const = 0.25, batch_size = 128, num_epochs = 100)
...
#    svm_hmm_obj.weights.save_weights(weight_name='declaration_of_independence_weights.mat')
    ...
    svm_hmm_test_obj = svm_hmm.SVM_HMM(feature_file_name = 'declaration_of_independence_feats.pfile', 
                                       label_file_name = 'declaration_of_independence_labels.pfile', 
